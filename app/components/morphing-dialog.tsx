...
export function MorphingDialog() {
  ...
  return (
    <>
      ...
      >
        <motion.div layoutId={`morph-image-${dialogRef.current ? 'open' : 'closed'}`} transition={spring} className="h-28 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600" />
          ...
          <DialogPortal>
            ...
            >
              ...
              >
                ...
                <motion.div layoutId={`morph-image-${dialogRef.current ? 'open' : 'closed'}`} transition={spring} className="h-52 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg" />
